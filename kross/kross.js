var letter = "";
var words = ["APPLE", "CAR", "BALL", "DOG","EGG", "FISH", "GIRAFFE",
            "HORSE", "JUICE", "KEY", "LION", "NUTS", "OWL", "PARROT",
            "QUEEN", "RABBIT", "SUN", "UMBRELLA", "VASE", "WHALE",
            "ZEBRA", "YELLOW", "RED", "ORANGE", "PURPLE"]
var words_count = 8;
var words_ukr = ["ЯБЛУКО", "АВТОМОБІЛЬ", "М'ЯЧ", "СОБАКА","ЯЙЦЕ", "РИБА",
                "ЖИРАФ", "КІНЬ", "СІК", "КЛЮЧ", "ЛЕВ", "ГОРІХИ", "СОВА",
                "ПАПУГА", "КОРОЛЕВА", "КРОЛИК", "СОНЦЕ", "ПАРАСОЛЬКА",
                "ВАЗА", "КИТ", "ЗЕБРА", "ЖОВТИЙ", "ЧЕРВОНИЙ", "ОРАНЖЕВИЙ",
                "ФІОЛЕТОВИЙ"]
var rows = 8;
var columns = 8;
